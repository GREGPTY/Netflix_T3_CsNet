<%@ Page Title="" Language="C#" MasterPageFile="~/html/MP.Master" AutoEventWireup="true" CodeBehind="Account.aspx.cs" Inherits="Netflix_T3.html.Account1" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <p>Hola a este modulo aun le falta programacion, pero puedes pasarte al de "traduccion de Python a C#"</p>
    <p>Es un curso de Python el cual quiero también hacer o recrear para C#</p>
